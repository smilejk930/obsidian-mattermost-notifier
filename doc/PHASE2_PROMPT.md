...
```text
doc/HANDOFF.md 전체와 README.md, 현재 소스 및 테스트를 먼저 읽고 Phase 2 Mattermost 연결을 구현해줘.
...
10. config.example.yaml, README.md, doc/HANDOFF.md를 구현과 일치하도록 갱신한다. token이나 서버 응답 본문은 오류 메시지에 포함하지 않는다.
